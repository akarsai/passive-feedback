...
#
# this file tests the proposed passive controller.
#
#
...
if __name__ == '__main__':
    ...
    # time discretization
    from helpers.time_integration import implicit_midpoint
    ...
    for tested_system in ['pendulum', 'van_der_pol']:
        ...
        if tested_system == 'pendulum':
            ...
            # ocp_max_iter = 15 # for other measurement y
        elif tested_system == 'van_der_pol':
            options = {
                'pol_degree_x': 15,
                'pol_degree_y': 15,
        ...
        plot_coupled_trajectory(
            ...
            tt = controller.simulation_tt,
            controller_trajectory_name = '\\overline{z}',
            controller_ylim = controller_ylim,
        ...
        plot_state_comparison(
            [
                ...
                (controller.simulation_tt, coupled_trajectory[:,:controller.plant.nsys], r'controller~\eqref{eq:passive-controller}', plt.cm.tab10(0) ),
                (controller.simulation_tt, coupled_trajectory_ekf[:,:controller.plant.nsys], r'controller~\eqref{eq:ekf-controller}', plt.cm.tab10(1) ),
                ],
